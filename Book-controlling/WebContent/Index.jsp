...
<body style="background-color:#c6baba">
 ...
 <div class="search">
            <form action = "SearchNameServlet" method = "GET">
                <input type="text" name="abc" placeholder="Search...">
            </form>
        </div>
    ...
    <div class="bodypagecontainer">
        ...
        <div class="slider">
            <a href="link1.php" target="_parent"><img class='photo' src="IMG/1.png" alt="img1" /></a>

            <a href="link2.php" target="_parent"><img class='photo' src="IMG/2.jpg" alt="img2" /></a>


            <a href="link3.php" target="_parent"><img class='photo' src="IMG/3.jpg" alt="img3" /></a>


            <a href="link4.php" target="_parent"><img class='photo' src="IMG/4.jpg" alt="img4" /></a>
        </div>
		...
		if (o<1)
		{
			if (p<=3)
			{
					for (int i =0;i<p;i++)				
				{
						...
						String URLbox = 	"<a href=\"bookservlet?"+(String)books.get(i).getBookName()+"\"><div class=\"bookimagecontainer\" \"><img src=\""+URL+"\" style=\"height:100%;width:100%\">"+"</div></a>";
			...
			else if (p>3)
			{
				...
				{	
					...
					String URLbox = 	"<a href=\"bookservlet?"+(String)books.get(k-1).getBookName()+"\"><div class=\"bookimagecontainer\" \"><img src=\""+URL+"\" style=\"height:100%;width:100%\">"+"</div></a>";
					String elements = bar+URLbox;
